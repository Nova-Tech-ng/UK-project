...
class GradePredictionModel:
    ...
    def predict(self, student_data):
        ...
        column_mapping = {
         ...
         # Or after creating the DataFrame:
        ...
        linear_regression_data = linear_regression_data.values  # Convert to NumPy array


        def reconstruct_encoder(feature_names):
            feature_mapping = {}
            for feature in feature_names:
                if "_" in feature:
                    base_feature, value = feature.split("_", 1)
                    if base_feature not in feature_mapping:
                        feature_mapping[base_feature] = []
                    feature_mapping[base_feature].append(feature)
                else:
